	...
	public class FolderInDatabase : ItemInDatabase {
		...
		internal void ReadFrom(string folder) {
            try {
                ...
                System.IO.DirectoryInfo[] subFolders = di.GetDirectories("*",SearchOption.AllDirectories);
                ...
                Parallel.ForEach(filesInFolder, fileInFolder =>
                {
                    ...
                    {
                        Name = fileInFolder.Name,

                        Attributes = fileInFolder.Attributes,
                        CreationTime = fileInFolder.CreationTime,
                        Extension = fileInFolder.Extension,
                        FullName = fileInFolder.FullName,
                        LastAccessTime = fileInFolder.LastAccessTime,
                        LastWriteTime = fileInFolder.LastWriteTime,
                        IsReadOnly = fileInFolder.IsReadOnly,
                        Length = fileInFolder.Length
                    };
