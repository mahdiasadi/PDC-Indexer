...
namespace PdcMirrorIndexer {
    ...
    public class DlgDiscProperties : FormDialogBase
    {
        ...
        protected internal Label labelguid;
        ...
        public DlgDiscProperties(DiscInDatabase discInDatabase)
            ...
            if (string.IsNullOrEmpty(discInDatabase.VolumeLabel))
                llVolumeLabel.Text = PdcMirrorIndexer.Core.Resources.NoLabel;
            else
            ...
            labelguid.Text  = discInDatabase.Gudid.ToString ();
            if (string.IsNullOrEmpty(discInDatabase.FromDrive))
                llDriveName.Text = PdcMirrorIndexer.Core.Resources.NoDrive;
            else
		...
		private void InitializeComponent() {
            ...
            this.toolTip1.ToolTipTitle = "PDC Disk Index Info";
            // 
            // tbPhysicalLocation
            // 
