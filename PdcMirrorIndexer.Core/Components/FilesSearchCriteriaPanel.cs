...
namespace PdcMirrorIndexer.Components
{
    ...
    public partial class FilesSearchCriteriaPanel : UserControl
    {
        ...
        private void showInvalidFormatMessage() {
            MessageBox.Show(PdcMirrorIndexer.Core.Resources.InvalidNumberFormat, ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e) {
            ...
            if (searchBtnClicked != null) {
                ...
                if (cbSize.Checked) {
                    ...
                    if (sizeFrom > sizeTo) {
                        MessageBox.Show(PdcMirrorIndexer.Core.Resources.InvalidSizeRange, ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                        tbSizeFrom.Focus();
                        return;
                    }
                ...
                if (cbDate.Checked) {
                    ...
                    if (dateFrom > dateTo) {
                        MessageBox.Show(PdcMirrorIndexer.Core.Resources.InvalidDateRange, ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                        dtpDateFrom.Focus();
                        return;
                    }
                }
